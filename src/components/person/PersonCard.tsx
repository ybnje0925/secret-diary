...
import { daysSince, formatRemindInterval, getRecentMemory, getRelationLine } from "../../utils/saramdam";
  ...
  return (
    <button onClick={() => onOpen(person.id)} className="flex min-h-[76px] w-full items-center gap-3 rounded-[16px] border border-[#ead8c9] bg-[#fffaf3] p-3 text-left shadow-soft">
      ...
      <span className="min-w-0 flex-1">
        ...
        <span className="mt-0.5 block text-xs text-[#7c6252]">{formatRemindInterval(person.remindIntervalDays)}</span>
