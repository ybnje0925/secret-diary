...
export default function QuickCaptureModal({
  ...
  const personPicker = (
    <div>
      <label className="block text-[11px] font-bold text-slate-500 mb-1.5">대상 인물</label>
      <select
        ...
        className="w-full text-xs bg-white border border-slate-200 rounded-lg p-2.5 focus:outline-none focus:ring-2 focus:ring-teal-600/20 font-medium text-slate-700"
      >
        {people.map(p => (
    ...
    <div id="quick-capture-modal-overlay" className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
      ...
      >
        <div className="pt-5 px-6 pb-3 border-b border-slate-200 flex items-center justify-between shrink-0">
          <h2 className="text-base font-bold text-slate-900">빠른 기록</h2>
          <button
              ...
              <div className="border border-slate-200 bg-slate-50 rounded-xl p-5 flex flex-col items-center justify-center space-y-3 min-h-[120px]">
                {isListening ? (
                  <div className="flex flex-col items-center gap-1.5">
                    ...
                    <span className="text-xs font-bold text-rose-600">듣고 있어요...</span>
                  </div>
                ) : (
                ...
                {!isListening ? (
                  <button
                    ...
                    className="py-2.5 px-5 bg-slate-900 hover:bg-black disabled:opacity-30 text-white text-xs font-bold rounded-full transition-all flex items-center gap-1.5"
                  >
                  ...
                  <button
                    ...
                    className="py-2.5 px-5 bg-rose-600 hover:bg-rose-700 text-white text-xs font-bold rounded-full transition-all flex items-center gap-1.5"
                  >
              ...
              {transcript && (
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full h-20 text-xs bg-white border border-slate-200 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-teal-600/20 resize-none text-slate-700"
                  />
                  <button
                    ...
                    className="w-full py-3 bg-teal-700 hover:bg-teal-800 disabled:opacity-40 text-white font-bold rounded-xl text-xs flex items-center justify-center gap-2 transition-all"
                  >
            ...
            <div className="space-y-4">
              ...
              {!selectedPerson && (
                <input
                  ...
                  placeholder="새 지인 이름"
                  className="w-full text-xs bg-white border border-slate-200 rounded-lg p-2.5 text-slate-700"
                />
              )}
              ...
              <textarea
                ...
                className="w-full h-32 text-xs bg-white border border-slate-200 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-teal-600/20 resize-none text-slate-700"
              />
              ...
              <button
                ...
                className="w-full py-3 bg-slate-900 hover:bg-black disabled:opacity-30 text-white font-bold rounded-xl text-xs flex items-center justify-center gap-2 transition-all"
              >
                ...
                {aiProposal && (
                  ...
                  >
                    ...
                    <div className="text-xs text-slate-600 space-y-1">
                      <p><span className="text-slate-400">대상:</span> <span className="font-bold text-slate-900">{aiProposal.detectedPersonName}</span></p>
                    ...
                    <button
                      ...
                      disabled={applied}
                      className="w-full py-2.5 bg-teal-700 hover:bg-teal-800 disabled:opacity-40 text-white font-bold rounded-lg text-xs flex items-center justify-center gap-2 transition-all"
                    >
